<x-app-layout>
    ...
    <div class="px-8 pt-2 hidden sm:flex sm:items-center sm:space-x-6">
        ...
        <x-nav-link class="py-2 px-4 rounded-md text-white bg-pink-500 hover:bg-pink-600" href="{{ route('Alta_Bienes') }}" :active="request()->routeIs('Alta_Bienes')">
            {{ __('Alta de Bienes') }}
        </x-nav-link>
    </div>
