                    ...
                    @foreach ($movimientosAgrupados as $folio => $movimientoData)
                        <div class="mb-6 mx-2 rounded-lg  shadow-md">
                            <div class="flex bg-gray-200">
                                ...
                                <div>
                                    <p class="px-3 py-2 text-xl font-semibold text-gray-800">Folio:
                                        {{ $folio }}
                                    </p>
                                </div>
                                <div>
                                    <p
                                        class="px-3 py-2 text-xl font-semibold text-gray-800  
                                    @if ($movimientoData['estado'] == 'COMPLETO') bg-green-500
                                        @elseif ($movimientoData['estado'] == 'PARCIAL') bg-yellow-500
                                        @elseif ($movimientoData['estado'] == 'TERMINADO' || $movimientoData['estado'] == 'CANCELADO') bg-red-500 @endif">
                                        Estado:
                            ...
                            <div class="flex bg-gray-200">
                                <div>
                                    <p class="px-3 py-2 text-xl font-semibold text-gray-800">Solicitante:
                                        {{ $movimientoData['personal']->nombre ?? 'No disponible' }}
                                    </p>
                                </div>
                                <div>
                                    <p class="px-3 py-2 text-xl font-semibold text-gray-800">Adscripción:
                                        {{ $movimientoData['personal']->area ?? 'No disponible' }}
                                    </p>
                                </div>
                            </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($movimientoData['biens'] as $bien)
                                        <tr>
                                            ...
                                            <td class="px-3 py-2 text-sm text-gray-900">
                                                @if ($bien->pivot->devuelto)
                                                    <p class="text-red-500">Devuelto</p>
                                                @else
                                                    <p class="text-green-500">No Devuelto</p>
                                                @endif
